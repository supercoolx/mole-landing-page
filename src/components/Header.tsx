    ...
    <header className={cn(
      ...
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#tokenomics" className="font-medium hover:text-game-blue transition-colors">Tokenomics</a>
          <a href="#vesting" className="font-medium hover:text-game-blue transition-colors">Vesting</a>
          <a href="#team" className="font-medium hover:text-game-blue transition-colors">Team</a>
          <a href="#partners" className="font-medium hover:text-game-blue transition-colors">Partners</a>
          <a href="#features" className="font-medium hover:text-game-blue transition-colors">Features</a>
          <Button 
